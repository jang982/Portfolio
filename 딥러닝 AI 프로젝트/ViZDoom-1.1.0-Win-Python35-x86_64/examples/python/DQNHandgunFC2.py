...
model_savefile = "../../tmp/simpler2.ckpt"
...
class DQN:
    def __init__(self,session, available_actions_count):
        ...
        self.FC2 = tf.contrib.layers.fully_connected(self.FC1, num_outputs=128, activation_fn=tf.nn.relu,
                                                weights_initializer=tf.contrib.layers.xavier_initializer(),
                                                biases_initializer=tf.constant_initializer(0.1))
        ...
        #액션의 갯수만큼 q아웃풋이 나옵니다.
        self.q = tf.contrib.layers.fully_connected(self.FC2, num_outputs=available_actions_count, activation_fn=None,
                                              weights_initializer=tf.contrib.layers.xavier_initializer(),
                                              biases_initializer=tf.constant_initializer(0.1))
